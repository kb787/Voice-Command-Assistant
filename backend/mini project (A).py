...
while True :
    ...
    if "open wikipedia" in task :
       ...
       speak(display)
        ...
        speak(" I am assistant created by KB sir and company an AI which uses speech recognition designed in Python. Various modules had been used pyttsx3 for giving sound , speech recognition for converting speech to text , os module for executing command opening a file from directory , smtplib for sending mails, tkinter for gui development. I can perform various tasks like sending an e-mail , playing song , opening variuos websites.I hope you enjoy your time with me  ")  
